            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="lg:col-span-1">
                    ...
                    <p class="text-gray-300 mb-4 text-sm">
                        National Vocational Training Institute Baddegama - Providing quality vocational education and skill development for a better future.
                    </p>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="#" class="text-gray-300 hover:text-white transition duration-300 text-sm">Vocational Training</a></li>
                        <li><a href="#" class="text-gray-300 hover:text-white transition duration-300 text-sm">Technical Courses</a></li>
                        <li><a href="#" class="text-gray-300 hover:text-white transition duration-300 text-sm">Skill Development</a></li>
                        <li><a href="#" class="text-gray-300 hover:text-white transition duration-300 text-sm">Certificate Programs</a></li>
                        <li><a href="#" class="text-gray-300 hover:text-white transition duration-300 text-sm">Short Courses</a></li>
                    </ul>
                </div>
            ...
            <div class="max-w-screen-xl mx-auto px-4 py-6">
                <div class="flex flex-col md:flex-row justify-between items-center">
                    <div class="text-gray-300 text-sm mb-4 md:mb-0">
                        &copy; 2024 NVTI Baddegama. All rights reserved.
                    </div>
