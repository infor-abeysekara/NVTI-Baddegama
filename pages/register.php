            ...
            <form id="registrationForm" class="space-y-6">
                ...
                <fieldset class="border-t border-gray-200 pt-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label for="identityCardNo" class="block text-sm font-medium text-gray-700 mb-1">Identity
                                Card No</label>
                            <input type="text" id="identityCardNo" name="identityCardNo" required
                    ...
                    <!-- Previous Education -->
                    <div class="mt-6">
                        <label for="previousEducation" class="block text-sm font-medium text-gray-700 mb-1">Previous
                            School / Major (Required for new students)</label>
                        <input type="text" id="previousEducation" name="previousEducation" required
                            placeholder="High School Name or Previous Major"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 transition duration-150">
                    </div>
                ...
                <fieldset class="border-t border-gray-200 pt-6">
                    ...
                    <div>
                        <label for="primaryCourse" class="block text-sm font-medium text-gray-700 mb-1">Primary Course
                            Track</label>
                    ...
                    <div class="mt-6">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Select Elective Courses (Max
                            3)</label>
                        <div class="space-y-3 p-4 border border-gray-200 rounded-lg bg-gray-50">
                            <div class="flex items-center">
                                ...
                                <label for="elective1" class="ml-3 text-sm font-medium text-gray-700">Introduction to
                                    Data Analytics</label>
                            </div>
                            <div class="flex items-center">
                                <input id="elective2" name="electives" type="checkbox" value="creative_writing"
                                    class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                                <label for="elective2" class="ml-3 text-sm font-medium text-gray-700">Advanced Creative
                                    Writing</label>
                            </div>
                            <div class="flex items-center">
                                <input id="elective3" name="electives" type="checkbox" value="robotics"
                                    class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                                <label for="elective3" class="ml-3 text-sm font-medium text-gray-700">Practical
                                    Robotics</label>
                            </div>
                            <div class="flex items-center">
                                <input id="elective4" name="electives" type="checkbox" value="financial_modeling"
                                    class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                                <label for="elective4" class="ml-3 text-sm font-medium text-gray-700">Financial Modeling
                                    Basics</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-6">
                        ...
                        <textarea id="notes" name="notes" rows="3"
                            placeholder="e.g., Requesting specific section times or accommodations."
                ...
                <div class="pt-6">
                    <button type="submit"
                        class="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-md text-lg font-medium text-white bg-[#7c1c20] hover:bg-[#4e1416] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-200 transform hover:scale-[1.01] active:scale-[0.98]">
                        Submit Registration
                    </button>
                </div>
